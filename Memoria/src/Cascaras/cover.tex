...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\autorPortada{Pablo Sánchez Martín}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\directorPortada{Carlos León Aznar, Ismael Sagredo Olivenza}
...
\textbf{Trabajo de Fin de Máster en Máster de Inteligencia Artificial}\\ [0.3em]
}
...
%     % \textbf{Calificación Pablo Sánchez Martín: }\textit{9.8}
% } AQUI SE PONE LA NOTA Y TAL
