...
Para comprobar el órden correcto de los nodos se ha recurrido al uso de un autómata finito no determinista (NFA por las siglas en inglés de Non-Deterministic Finite Automata) definido de la siguiente manera:
\begin{itemize}
