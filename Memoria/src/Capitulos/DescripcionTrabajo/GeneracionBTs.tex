...
\begin{figure}[H]
    ...
    \caption[Chain-of-Thought del \gls{LLM} que genera el pseudocódigo.]{Diagrama de la cadena de pensamiento que sigue el \gls{LLM} generador de pseudocódigo.}
    \label{fig:CoT-Code}
\end{figure}
