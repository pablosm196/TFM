...
El objetivo general de este proyecto es la implementación de una herramienta que puedan usar de forma sencilla e intuitiva diseñadores, tanto expertos como los que no tienen una base técnica, para poder generar árboles de comportamiento de una manera más eficaz que mediante la creación manual y con una calidad similar a la humana, con el fin de aliviar su trabajo.
No se busca sustituir el trabajo de un diseñador, sino aportarles una herramienta que les devuelva unas estructuras fácilmente modificables para matizar ciertos aspectos o cambiar de forma sencilla los comportamientos generados.
...
\begin{itemize}
	...
	\item Implementación de un sistema de validación de los árboles generados para comprobar que son válidos en cuanto a respeto de dependencias de nodos y cumplimiento de objetivos.
...
\begin{itemize}
	...
	En esta herramienta se ha creado una pila de tareas y condicionales necesarias para la creación de comportamientos, así como varios escenarios para probar las generaciones de los árboles de comportamiento.
	...
	\item \texttt{Hugging Face}: Es un ecosistema de código abierto para la distribución de modelos de Machine Learning, librerías y datasets del Procesamiento de Lenguaje Natural.
...
\begin{enumerate}
	...
	En este capítulo se repasan diferentes métodos de generación de comportamientos usados en videojuegos, tanto su definición como su evolución en la industria y academia, remarcando el interés especial en los árboles de comportamiento.
...
\begin{itemize}
	...
	\item \texttt{Memoria}: Código fuente en LaTeX de este documento.
\end{itemize}
...
En todo caso la estructura del documento, así como las ideas que transmite y la responsabilidad final sobre el contenido recae en el autor.