...
Aún así, actualmente se siguen utilizando como se puede ver en trabajos recientes como \cite{FSM-NPC3}, donde implementan FSM de forma clásica para \glspl{npc} o en \cite{FSM-ML}, donde combinan FSM con técnicas de Machine Learning como Q-Learning y DQN para controlar \glspl{npc} de un RPG.
